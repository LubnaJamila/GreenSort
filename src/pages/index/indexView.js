...
export default class IndexView {
    ...
    render() {
        console.log('Rendering IndexView');
        this.app.innerHTML = `
    ...
    setupEventListeners() {
        ...
        const registerHandler = (e) => {
            ...
            // Gunakan detail yang sesuai dengan route di router.js
            const event = new CustomEvent('navigate', { detail: { page: 'register' } });
            document.dispatchEvent(event);
        };
        
        registerBtn.addEventListener('click', registerHandler);
        // Simpan referensi event listener untuk cleanup nanti
        this.eventListeners.push({ element: registerBtn, type: 'click', handler: registerHandler });
        }
        ...
        if (loginBtn) {
          ...
          // Simpan referensi event listener untuk cleanup nanti
          this.eventListeners.push({ element: loginBtn, type: 'click', handler: loginHandler });
        }
    }
    
    // Metode untuk membersihkan event listener saat view sudah tidak digunakan
    ...
    // Metode untuk digunakan oleh presenter saat destroy
    destroy() {
        console.log('Destroying IndexView');
        this.removeEventListeners();
    }
  }